 ...
 * probe only ever touches its own sandbox root and one "Plans" subfolder.
 * Paths are plain relative strings ("probe.txt", "Plans", "Plans/x.json");
 * leading "./" is stripped, nothing else is normalised.
 ******************************************************************************
 */

#ifndef INTERVALS_FLAT_FILE_SYSTEM_HPP
#define INTERVALS_FLAT_FILE_SYSTEM_HPP
...
#endif // INTERVALS_FLAT_FILE_SYSTEM_HPP
