 ...
 * @brief   The Intervals Probe's one Service -> GUI message.
 ******************************************************************************
 */

#ifndef INTERVALS_PROBE_MESSAGES_HPP
#define INTERVALS_PROBE_MESSAGES_HPP
...
#endif // INTERVALS_PROBE_MESSAGES_HPP
